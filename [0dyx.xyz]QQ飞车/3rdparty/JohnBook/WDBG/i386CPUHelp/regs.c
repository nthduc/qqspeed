    ...
    )
{
    switch (regnum) {
        case REGGS:
            return dp->context.SegGs;
        case REGFS:
            return dp->context.SegFs;
        case REGES:
            return dp->context.SegEs;
        case REGDS:
            return dp->context.SegDs;
        case REGEDI:
            return dp->context.Edi;
        case REGESI:
            return dp->context.Esi;
        case REGSI:
            return(dp->context.Esi & 0xffff);
        case REGDI:
            return(dp->context.Edi & 0xffff);
        case REGEBX:
            return dp->context.Ebx;
        case REGEDX:
            return dp->context.Edx;
        case REGECX:
            return dp->context.Ecx;
        case REGEAX:
            return dp->context.Eax;
        case REGEBP:
            return dp->context.Ebp;
        case REGEIP:
            return dp->context.Eip;
        case REGCS:
            return dp->context.SegCs;
        case REGEFL:
            return dp->context.EFlags;
        case REGESP:
            return dp->context.Esp;
        case REGSS:
            return dp->context.SegSs;
        case PREGEA:
            return 0;
        case PREGEXP:
            return 0;
        ...
        case PREGP:
            return 0;
        case REGDR0:
            return dp->context.Dr0;
        case REGDR1:
            return dp->context.Dr1;
        case REGDR2:
            return dp->context.Dr2;
        case REGDR3:
            return dp->context.Dr3;
        case REGDR6:
            return dp->context.Dr6;
        case REGDR7:
            return dp->context.Dr7;
        default:
            return 0;
        }
}
