...
----------------------------------------------------------------------*/
// SettingsMasterOptions.cpp : Implementation of CSettingsMasterOptions
#include "stdafx.h"
#include "SettingsMasterOptions.h"


// CSettingsMasterOptions
LPCTSTR k_HOSTCLSID =
   _T ( "CLSID\\{7E177BE2-5391-469d-8A4E-325472BC91EE}\\InprocServer32" ) ;

LRESULT CSettingsMasterOptions :: OnShowWindow ( UINT   ,
                                                 WPARAM ,
                                                 LPARAM ,
                                                 BOOL&    )
{
...
LRESULT CSettingsMasterOptions::OnSize(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
{
...
void CSettingsMasterOptions::Reset()
{
	m_pHost = NULL;
...
HRESULT CSettingsMasterOptions::HostUserControl(BSTR Assembly, BSTR Class, IUnknown **ppControlObject)
{
	RECT rc;
...
HRESULT CSettingsMasterOptions::FinalConstruct()
{
