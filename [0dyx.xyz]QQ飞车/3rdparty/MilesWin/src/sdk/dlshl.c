...
void   AILCALL AIL_API_DLS_set_reverb_levels(HDLSDEVICE dls,
                                             F32     dry_level,
                                             F32     wet_level)
{
  if (dls) {
...
#endif
    {
      AIL_set_sample_reverb_levels(dls->sample,dry_level,wet_level);
    }
  }
}

void   AILCALL AIL_API_DLS_get_reverb_levels(HDLSDEVICE dls,
                                             F32 FAR*    dry_level,
                                             F32 FAR*    wet_level)
{
  if (dls) {
...
#endif
    {
      AIL_sample_reverb_levels(dls->sample,dry_level,wet_level);
    }
  }
}
