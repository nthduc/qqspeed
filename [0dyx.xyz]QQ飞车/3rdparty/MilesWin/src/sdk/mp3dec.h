...
{
#ifdef IS_PS2
   F32    dummy2[16];   // 1 cache line to avoid problems with DMA/cache interactions
#endif
...
#ifdef IS_PS2
   F32    dummy3[16];   // 1 cache line to avoid problems with DMA/cache interactions
#endif
...
extern void AILCALL SSE_dewindow_and_write(F32 FAR *u,
                                           F32 const FAR *dewindow,
                                           S32      start,
                                           S16 FAR *samples,
                                           S32      output_step,
...
extern void C_poly_filter(const F32 FAR *src,
                          const F32 FAR *b,
                          S32            phase,
                          F32       FAR *out1,
                          F32       FAR *out2);
...
extern void C_IMDCT_3x12(F32 FAR *in,
                         S32      sb,
                         F32 FAR *result,
                         F32 FAR *save);

extern void C_IMDCT_1x36(F32 FAR *in,
                         S32      sb,
                         F32 FAR *result,
                         F32 FAR *save,
                         F32 FAR *window);
...
U32 inline view_bits8(U8 FAR *data, S32 bitpos)
{
   U32 val;
