...
#if defined(IS_WINDOWS) || defined(IS_XBOX)
                                              ...
                                              AILSOUNDINFO const FAR *info )
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_info(0x%lX,0x%lX)\r\n",S,info);
      }
                                                   ...
                                                   F32     pan)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_volume_pan(0x%lX,%f,%f)\r\n",S,volume,pan);
      }
                                                      ...
                                                      F32     sub_level )
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_51_volume_pan(0x%lX,%f,%f,%f,%f,%f)\r\n",S,volume,pan,fb_pan,center_level,sub_level);
      }
                                                  ...
                                                  F32 FAR * sub_level )
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_51_volume_pan(0x%lX,%lX,%lX,%lX,%lX,%lX)\r\n",S,volume,pan,fb_pan,center_level,sub_level);
      }
                                                        ...
                                                        F32     sub_level )
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_51_volume_levels(0x%lX,%f,%f,%f,%f,%f)\r\n",S,f_left_level,f_right_level,b_left_level,b_right_level,center_level,sub_level);
      }
                                                    ...
                                                    F32 FAR * sub_level )
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_51_volume_levels(0x%lX,%lX,%lX,%lX,%lX,%lX)\r\n",S,f_left_level,f_right_level,b_left_level,b_right_level,center_level,sub_level);
      }
                                                      ...
                                                      F32     right_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_volume_levels(0x%lX,%f,%f)\r\n",S,left_level,right_level);
      }
                                                      ...
                                                      F32     wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_reverb_levels(0x%lX,%f,%f)\r\n",S,dry_level,wet_level);
      }
                                                       ...
                                                       F32     cut_off)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_sample_low_pass_cut_off(0x%lX,%f)\r\n",S,cut_off);
      }
...
void         AILEXPORT AIL_sample_volume_pan         (HSAMPLE S,F32 FAR*volume, F32 FAR* pan)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_volume_pan(0x%lX,0x%lX,0x%lX)\r\n",S,volume,pan);
      }
                                                  ...
                                                  F32 FAR * right_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_volume_levels(0x%lX,0x%lX,0x%lX)\r\n",S,left_level,right_level);
      }
                                                  ...
                                                  F32 FAR * wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_reverb_levels(0x%lX,%lX,%lX)\r\n",S,dry_level,wet_level);
      }
...
F32         AILEXPORT AIL_sample_low_pass_cut_off(HSAMPLE S )
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_sample_low_pass_cut_off(0x%lX)\r\n",S);
      }
                                              ...
                                              F32        master_volume)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_digital_master_volume_level(0x%X,%f)\r\n",dig,master_volume);
      }
...
F32     AILEXPORT AIL_digital_master_volume_level   (HDIGDRIVER dig)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_digital_master_volume_level(0x%X)\r\n",dig);
      }
                                                              ...
                                                              F32     wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_digital_master_reverb_levels(0x%lX,%f,%f)\r\n",dig,dry_level,wet_level);
      }
...
DXDEF
void         AILEXPORT AIL_set_digital_master_room_type  (HDIGDRIVER dig, //)
                                                          S32     room_type)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_digital_master_room_type(0x%lX,%li)\r\n",dig,room_type);
      }

   IN_AIL;

   dsailcall2(AIL,set_digital_master_room_type,void,dig,room_type);
                                                          ...
                                                          F32 FAR * wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_digital_master_reverb_levels(0x%lX,%lX,%lX)\r\n",dig,dry_level,wet_level);
      }
                                                              ...
                                                              F32     reverb_damping)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_digital_master_reverb(0x%lX,%f,%f,%f)\r\n",dig,reverb_time,reverb_predelay,reverb_damping);
      }
                                                  ...
                                                  F32 FAR * reverb_damping)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_digital_master_reverb(0x%lX,%lX,%lX,%lX)\r\n",dig,reverb_time,reverb_predelay,reverb_damping);
      }
...
F32 AILEXPORT AIL_redbook_volume_level(HREDBOOK hand)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_redbook_volume_level(0x%lX)\r\n",hand);
      }
...
F32 AILEXPORT AIL_redbook_set_volume_level(HREDBOOK hand, F32 volume)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_redbook_set_volume(0x%lX,%f)\r\n",hand,volume);
      }
...
void   AILEXPORT AIL_quick_set_volume (HAUDIO audio, F32 volume, F32 extravol)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_quick_set_volume(0x%lX, %f, %f)\r\n",audio,volume,extravol);
      }
                                              ...
                                              F32     wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_quick_set_reverb_levels(0x%lX, %f, %f)\r\n",audio,dry_level,wet_level);
      }
                                                ...
                                                F32    cut_off)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_quick_set_low_pass_cut_off(0x%lX, %f)\r\n",audio,cut_off);
      }
...
DXDEF
void AILEXPORT AIL_set_stream_volume_pan(HSTREAM stream,F32 volume,F32 pan)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_stream_volume_pan(0x%lX, %f, %f)\r\n",stream,volume,pan);
      }

   IN_AIL_NM;

   ailcall3(AIL,set_stream_volume_pan,void,stream,volume,pan);
...
DXDEF
void         AILEXPORT AIL_set_stream_volume_levels  (HSTREAM S, //)
                                                      F32     left_level,
                                                      F32     right_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_stream_volume_levels(0x%lX,%f,%f)\r\n",S,left_level,right_level);
      }

   IN_AIL_NM;

   dsailcall3(AIL,set_stream_volume_levels,void,S,left_level,right_level);
...
DXDEF
void         AILEXPORT AIL_set_stream_reverb_levels  (HSTREAM S, //)
                                                      F32     dry_level,
                                                      F32     wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_stream_reverb_levels(0x%lX,%f,%f)\r\n",S,dry_level,wet_level);
      }

   IN_AIL_NM;

   dsailcall3(AIL,set_stream_reverb_levels,void,S,dry_level,wet_level);
...
DXDEF
void         AILEXPORT AIL_set_stream_low_pass_cut_off(HSTREAM S, //)
                                                       F32     cut_off)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_stream_low_pass_cut_off(0x%lX,%f)\r\n",S,cut_off);
      }

   IN_AIL_NM;

   dsailcall2(AIL,set_stream_low_pass_cut_off,void,S,cut_off);
...
DXDEF
void AILEXPORT AIL_stream_volume_pan(HSTREAM stream,
                                     F32 FAR * volume,
                                     F32 FAR * pan)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_stream_volume_pan(0x%lX,0x%lX,0x%lX)\r\n",stream,volume,pan);
      }

   IN_AIL_NM;

   ailcall3(AIL,stream_volume_pan,void,stream,volume,pan);
...
DXDEF
void         AILEXPORT AIL_stream_volume_levels  (HSTREAM S, //)
                                                  F32 FAR * left_level,
                                                  F32 FAR * right_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_stream_volume_levels(0x%lX,%lX,%lX)\r\n",S,left_level,right_level);
      }

   IN_AIL_NM;

   ailcall3(AIL,stream_volume_levels,void,S,left_level,right_level);
...
DXDEF
void         AILEXPORT AIL_stream_reverb_levels  (HSTREAM S, //)
                                                  F32 FAR * dry_level,
                                                  F32 FAR * wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_stream_reverb_levels(0x%lX,%lX,%lX)\r\n",S,dry_level,wet_level);
      }

   IN_AIL_NM;

   dsailcall3(AIL,stream_reverb_levels,void,S,dry_level,wet_level);
...
DXDEF
F32         AILEXPORT AIL_stream_low_pass_cut_off(HSTREAM S)
{
   F32 result;

   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_stream_low_pass_cut_off(0x%lX)\r\n",S);
      }

   IN_AIL_NM;

   result = dsailcall1(AIL,stream_low_pass_cut_off,F32,S);
...
DXDEF
void   AILEXPORT AIL_DLS_set_reverb_levels(HDLSDEVICE dls,
                                           F32     dry_level,
                                           F32     wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_DLS_set_reverb_levels(0x%lX, %f, %f)\r\n",dls,dry_level,wet_level);
      }

   IN_AIL;

   ailcall3(AIL,DLS_set_reverb_levels,void,dls,dry_level,wet_level);
...
DXDEF
void   AILEXPORT AIL_DLS_get_reverb_levels(HDLSDEVICE dls,
                                           F32 FAR*    dry_level,
                                           F32 FAR*    wet_level)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_DLS_get_reverb_levels(0x%lX, 0x%lX, 0x%lX)\r\n",dls,dry_level,wet_level);
      }

   IN_AIL;

   ailcall3(AIL,DLS_get_reverb_levels,void,dls,dry_level,wet_level);
                                                  ...
                                                  void const FAR *  val)
{
   ...
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_3D_sample(%lX,%s,%lX)\r\n",
         samp,name,val);
      }
                                                  ...
                                                  F32       volume)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_3D_sample_volume(%lX,%f)\r\n",
          samp,volume);
      }
...
//############################################################################
DXDEF
void       AILEXPORT AIL_set_3D_sample_exclusion (H3DSAMPLE S, //)
                                                  F32       exclusion)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_3D_sample_exclusion(%lX,%f)\r\n",
          S, exclusion);
      }

   IN_AIL;

   AIL_API_set_3D_sample_exclusion(S, exclusion);
                                                    ...
                                                    F32       outer_volume)
{
   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_set_3D_sample_cone(%lX,%f,%f,%f)\r\n",
...
//############################################################################
DXDEF
F32        AILEXPORT AIL_3D_sample_exclusion (H3DSAMPLE S)
{
   F32 result;

   START
      {
      AIL_fprintf(AIL_debugfile,"AIL_3D_sample_exclusion(%lX)\r\n",
          S);
      }

   IN_AIL_NM;

   result = AIL_API_3D_sample_exclusion(S);
...
//############################################################################
DXDEF F32 AILEXPORT      AIL_3D_sample_volume  (H3DSAMPLE samp)
{
   F32 result;
