...
M3DRESULT  AILCALL AIL_API_open_3D_provider        (HPROVIDER provider)
{
   ...
   RIB_INTERFACE_ENTRY sample_request[] =
      ...
      { RIB_FUNCTION, "M3D_3D_sample_exclusion",         (U32) &M3D->sample_exclusion            ,RIB_NONE },
      ...
      { RIB_FUNCTION, "M3D_set_3D_sample_exclusion",     (U32) &M3D->set_3D_sample_exclusion     ,RIB_NONE },
                                                    ...
                                                    U32       offset)
{
   ...
   M3D->set_3D_sample_offset(desc->actual, offset & ~1 );
}
...
F32        AILCALL AIL_API_3D_sample_volume        (H3DSAMPLE samp)
{
   H3D FAR *desc = (H3D FAR *) samp;
...
//############################################################################
//#                                                                          #
//# AIL_API_set_3D_sample_exclusion                                          #
//#                                                                          #
//############################################################################

void       AILCALL AIL_API_set_3D_sample_exclusion (H3DSAMPLE S, //)
                                                    F32       exclusion)
{
   H3D FAR *desc = (H3D FAR *) S;
   ...
   if (M3D->set_3D_sample_exclusion == NULL)
      {
      return;
      }

   M3D->set_3D_sample_exclusion(desc->actual, exclusion);
}
...
//############################################################################
//#                                                                          #
//# AIL_API_3D_sample_exclusion                                              #
//#                                                                          #
//############################################################################

F32        AILCALL AIL_API_3D_sample_exclusion (H3DSAMPLE S)
{
   H3D FAR *desc = (H3D FAR *) S;
   ...
   if (M3D->sample_exclusion == NULL)
      {
      return -1.0F;
      }

   return M3D->sample_exclusion(desc->actual);
}
