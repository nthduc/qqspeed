...
AIL_INPUT_INFOR=record    { Input descriptor type }
...
PAIL_INPUT_INFOR = ^AIL_INPUT_INFOR;
...
procedure AIL_set_sample_volume_pan (S : HSAMPLE; volume : F32; pan : F32); stdcall;
...
procedure  AIL_sample_volume_pan    (S : HSAMPLE; var vol:F32; var pan:F32); stdcall;
...
function AIL_open_input(var info:AIL_INPUT_INFOR):HDIGINPUT; stdcall;

procedure AIL_close_input(idig:HDIGINPUT); stdcall;

function AIL_input_info(idig:HDIGINPUT):PAIL_INPUT_INFOR; stdcall;

function AIL_set_input_state(idig:HDIGINPUT;enable:S32):S32; stdcall;
...
procedure AIL_set_stream_volume_pan(stream:HSTREAM; volume:F32; pan: F32); stdcall;

procedure AIL_set_stream_pan(stream:HSTREAM; pan:S32); stdcall;

procedure AIL_stream_volume_pan(stream:HSTREAM; var vol:F32; var pan: F32); stdcall;
...
function AIL_3D_sample_volume        (S:H3DSAMPLE):F32; stdcall;
...
procedure AIL_set_sample_volume_pan (S : HSAMPLE; volume : F32; pan:F32);
          external MSS_lib name '_AIL_set_sample_volume_pan@12';
...
procedure AIL_sample_volume_pan         (S : HSAMPLE; var vol:F32; var pan:F32);
          external MSS_lib name '_AIL_sample_volume_pan@12';
...
function AIL_open_input(var info:AIL_INPUT_INFOR):HDIGINPUT;
          external MSS_lib name '_AIL_open_input@4';

procedure AIL_close_input(idig:HDIGINPUT);
          external MSS_lib name '_AIL_close_input@4';

function AIL_input_info(idig:HDIGINPUT):PAIL_INPUT_INFOR;
          external MSS_lib name '_AIL_input_info@4';

function AIL_set_input_state(idig:HDIGINPUT;enable:S32):S32;
...
procedure AIL_set_stream_volume_pan(stream:HSTREAM; volume:F32;pan:F32);
          external MSS_lib name '_AIL_set_stream_volume_pan@12';

procedure AIL_set_stream_pan(stream:HSTREAM; pan:S32);
          external MSS_lib name '_AIL_set_stream_pan@8';

procedure AIL_stream_volume_pan(stream:HSTREAM;var vol:F32;var pan:F32);
          external MSS_lib name '_AIL_stream_volume_pan@12';
...
function AIL_3D_sample_volume        (S:H3DSAMPLE):F32;
