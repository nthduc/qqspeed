================================================================================
    MICROSOFT 基础类库： dbgview 项目概述
===============================================================================

应用程序向导已为您创建了此 dbgview 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 dbgview 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 dbgview.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
dbgviewDoc.h、dbgviewDoc.cpp - 文档
    这些文件包含 CdbgviewDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CdbgviewDoc::Serialize）。
dbgviewView.h、dbgviewView.cpp - 文档视图
    这些文件包含 CdbgviewView 类。
    CdbgviewView 对象用于查看 CdbgviewDoc 对象。
res\dbgviewDoc.ico
    这是一个图标文件，用作 
    CdbgviewDoc 类 MDI 子窗口的图标。  此图标包含在主
    资源文件 dbgview.rc 中。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 dbgview.pch 的预编译头文件 (PCH)
