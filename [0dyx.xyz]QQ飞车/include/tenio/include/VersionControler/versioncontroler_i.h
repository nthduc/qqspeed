...
{  
	...
	public:
		 ...
		 */
		virtual int GetLocalFileVersion(LPCTSTR lpszDownloadType, LPCTSTR lpszFileName) = 0;

		virtual int GetUpdateFileVersion(LPCTSTR lpszDownloadType, LPCTSTR lpszFileName) = 0;
        
		/**
		 * @brief 更新文件的版本，将本地文件的版本号改为SERVER端文件的版本号
		 * @param lpszFilename [in] 文件名
		 */
		virtual void UpdateLocalFileVersion(LPCTSTR lpszDownloadType, LPCTSTR lpszFileName) = 0;
		 ...
		 */
		virtual void SetLocalFileVersion(LPCTSTR lpszDownloadType, LPCTSTR lpszFileName, int nVersion) = 0;
	     ...
	     * </p>
		 */
        virtual BOOL DeleteLocalFileVersion(LPCTSTR lpszDownloadType, LPCTSTR lpszFileName) = 0;
		 ...
		 */
		virtual BOOL IsNewestVersion(LPCTSTR lpszDownloadType, LPCTSTR lpszFileName) = 0;
